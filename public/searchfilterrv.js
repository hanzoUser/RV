...
$("#atom").on('click', null, function raw_filter_search_buttons() {
	...
	for (i = 0; i < (rows2.length - 0); i++) {
		...
		console.log(bbb)
		    if  (flowfiltered.includes(bbb))  { 
							console.log(bbb);
							var rows3 = $('table tbody tr:nth-child(' + k + ')');
							rows3.show()
						}
			}
})

$("#chassis").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [   
        "par_adm_fdi_1", 
...
$("#disp").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
        "dispbuf1par1",
...
$("#memss").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
		"par_ibecc",
...
$("#vpu").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
        "nce",
