...
for ( i = 0; i < (allpartitionlength.length); i++) {



	//rows[5].getElementsByTagName("TD")[3].style.backgroundColor = "yellow";
    //rows[5].getElementsByTagName("TD")[4].style.fontWeight = "bold";
    ///////////////////////////////////////////////////
	console.log("up to here");
    
	
	for ( k = 1; k < 9 ; k++) {
		//if (rows[i].getElementsByTagName("TD")[3].outerText) {
			violationsyellow = allpartitionlength[i].getElementsByTagName("TD")[k].outerText;
			if (violationsyellow>0 ) {
				console.log(violationsyellow)
				//rows[i].getElementsByTagName("TD")[k].outerHTML = "yellow";
				allpartitionlength[i].getElementsByTagName("TD")[k].style.fontWeight = "bold";
			}
		//}
    }
    ...
    //console.log(rows[i].getElementsByTagName("TD")[1].outerText)

	//rows[6].getElementsByTagName("TD")[3].style.backgroundColor = "blue";
	//rows[7].getElementsByTagName("TD")[3].style.backgroundColor = "blue";
    ///////////////////////////////////////////////////
